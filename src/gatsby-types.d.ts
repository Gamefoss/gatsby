...
type podcastRssFeedEpisodeItem = {
  ...
  readonly dc_creator: Maybe<Scalars['String']>;
...
type podcastRssFeedEpisodeItem_isoDateArgs = {
  difference: InputMaybe<Scalars['String']>;
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  locale: InputMaybe<Scalars['String']>;
...
type podcastRssFeedEpisodeItemFieldSelector = {
  ...
  readonly dc_creator: InputMaybe<FieldSelectorEnum>;
...
type podcastRssFeedEpisodeItemFilterInput = {
  ...
  readonly dc_creator: InputMaybe<StringQueryOperatorInput>;
...
type podcastRssFeedEpisodeItemSortInput = {
  ...
  readonly dc_creator: InputMaybe<SortOrderEnum>;
